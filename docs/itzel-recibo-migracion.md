...
Fecha: 2026-09-24T00:25:03.484054-06:00 (America/Mexico_City)
...
## Accesos
1. **GitHub escritura PROBADA** — rama `chore/itzel-migracion-recibo-20260924`, commit `78e6d5f879b328b552f6f624623aace0e6efd73c` (`docs/itzel-migracion-recibo.md`). Ricardo confirmó. Master intacto.
2. **Sitio público — lectura EJECUTADA** — `/` + `/api/actividad|anuncios|iniciativas|casos-ia` HTTP 200; actividad reciente `2026-09-22T09:04:56.613Z`.
...
## Modelos
- Vercel (nombres): `ANTHROPIC_API_KEY`, `CLAUDE_API_KEY`, `OPENROUTER_API_KEY`.
