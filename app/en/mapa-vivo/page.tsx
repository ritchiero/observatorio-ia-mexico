    ...
    <div className="relative h-[100svh] min-h-[560px] w-full overflow-hidden" style={{ background: '#05070C', color: '#E7ECF7' }}>
      ...
      <div className="absolute left-5 md:left-10 top-[16%] md:top-[18%] z-10 max-w-[560px] pointer-events-none pr-5">
        ...
        <div className="mt-6 flex flex-wrap gap-3 pointer-events-auto">
          <Link href="/en/grafo" className="font-sans-tech text-[13px] font-semibold rounded-full px-5 py-2.5 transition-transform hover:scale-[1.03]"
            style={{ color: '#05070C', background: 'linear-gradient(135deg, #3DE0FF, #4D7BFF)' }}>
            Explore the interactive map →
          </Link>
          <Link href="/en/metodologia" className="font-sans-tech text-[13px] rounded-full px-5 py-2.5 border border-white/15 text-[#E7ECF7] hover:border-cyan-300/50 transition-colors">
      ...
      <div className="absolute bottom-5 md:bottom-8 right-5 md:right-10 z-10 text-right font-sans-tech text-[11px] leading-5 text-[#7886A2]">
        <div className="pointer-events-none"><span className="inline-block h-2 w-2 rounded-full align-middle mr-1.5" style={{ background: '#3DE0FF', boxShadow: '0 0 8px #3DE0FF88' }} />1 dot = 1 public object: record, source or event</div>
        <div className="pointer-events-none">drag to rotate · scroll to zoom · click opens the record</div>
