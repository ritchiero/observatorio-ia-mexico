          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-gray-700 font-sans-tech text-sm leading-relaxed">
                There are two parallel tracks: (1) a <strong>constitutional amendment to Art. 73</strong> (Sen. Saúl Monreal) to empower Congress to legislate on AI, and (2) a <strong>Ley General de IA proposal</strong> from the Comisión de IA del Senado (the Senate&apos;s AI Commission), led by Sen. Rolando Zapata. The vote originally expected for <strong>February 25, 2026 did not take place</strong>; both tracks remain <strong>in committee, with no date set for a dictamen (committee report) or a floor vote</strong>. This page documents the content and progress of the proposal, not a law in force.
              </p>
            </div>
          </div>
        </div>
