...
export const metadata = {
  ...
  description: 'AI legislative proposals and historical materials in Mexico. Documentary review in progress; subsequent legislative status remains to be verified.',
      ...
      <main className="max-w-5xl mx-auto px-4 py-8 sm:py-12">
        ...
        <div className="mb-10">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-amber-50 border border-amber-200/50 rounded-full mb-4">
            ...
            <span className="text-xs font-sans-tech text-amber-700 font-medium">Proposals and background · review in progress</span>
          </div>
        ...
        <div className="bg-amber-50 border-2 border-amber-300 rounded-2xl p-5 mb-8">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="font-sans-tech text-sm font-bold text-amber-900 mb-1">Documentary review in progress</h3>
              <p className="text-amber-900 font-sans-tech text-sm leading-relaxed">This page collects proposals and background materials, not an exhaustive list of laws in force. The review started on <strong>September 6, 2026</strong> distinguishes document contents from legislative status. A bill or working draft does not by itself establish approval, publication or entry into force.</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-2xl p-6 mb-10">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="font-sans-tech text-sm font-semibold text-gray-800 mb-2">Scope of the first documentary review</h3>
              <p className="text-gray-700 font-sans-tech text-sm leading-relaxed">The original proposal by <strong>Saúl Monreal, dated February 3, 2026</strong>, would add section XXXII to constitutional Article 73. Its contents were checked against the PDF in the Sistema de Información Legislativa. Subsequent proceedings and the status of other proposals remain under review; the earlier summary is not presented as an up-to-date account of legislative status.</p>
            </div>
          </div>
        </div>
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
            <div className="bg-amber-50 border border-amber-200 rounded-xl p-5">
              ...
              <p className="text-xs text-amber-700 font-sans-tech mt-2 italic">Note: The formal bill filed on February 3, 2026 <strong>only amends Art. 73</strong>. The document reviewed does not propose amending Art. 3; this does not establish the absence of other bills.</p>
            </div>
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-5">
              ...
              <p className="text-sm text-blue-800 font-sans-tech leading-relaxed">Contents of the LGIA v1 working document linked on this page. Contains <strong>223 articles + 10 transitory articles + a Regulatory Glossary</strong> across 14 Títulos (Titles). The result of consultation with <strong>72 specialists</strong>.</p>
            </div>
          </div>
          ...
          <div className="mb-8 bg-indigo-50 border border-indigo-200 rounded-xl p-5">
            <div className="flex items-center gap-2 mb-3"><Database size={16} className="text-indigo-600" /><h3 className="font-sans-tech text-sm font-semibold text-indigo-900">Definition in the working document (Art. 4, fracc. XX)</h3></div>
        ...
        <section className="mb-12">
          ...
          <div className="space-y-3">
            ...
            <a href="https://drive.google.com/file/d/1IVWTfK74RSVAMDs6cZ8B-WLuafOygFmO/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 bg-teal-50 border border-teal-200 rounded-xl p-5 hover:border-teal-400 transition-colors group">
              <div className="w-12 h-12 bg-teal-600 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:bg-teal-700 transition-colors"><FileText size={20} className="text-white" /></div>
              <div className="flex-1"><p className="text-sm font-sans-tech font-semibold text-teal-900 group-hover:text-teal-700">Ley General de Inteligencia Artificial — working document</p><p className="text-xs text-teal-700 font-sans-tech mt-1">LGIA v1 — linked working document; parliamentary status remains to be verified</p></div>
              <ExternalLink size={16} className="text-teal-400 flex-shrink-0 group-hover:text-teal-600" />
            </a>
          ...
          <p className="text-xs text-gray-400 font-sans-tech mt-3 italic">The link provides the LGIA v1 text; availability does not establish that it is an approved committee report. The Saúl Monreal proposal is dated February 3, 2026.</p>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-600 font-sans-tech text-sm mb-4">These references belong to the schedule circulated in February 2026. They are not upcoming sessions and do not establish that an AI bill was voted on or approved. Consult the official congressional agenda and records to verify each session.</p>
          <div className="space-y-3">
            <div className="bg-gray-50 border border-gray-200 rounded-xl p-5">
              <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
                <div className="flex items-center gap-2"><span className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-red-100 text-red-700 rounded-lg text-xs font-sans-tech font-semibold"><span className="w-2 h-2 bg-red-500 rounded-full animate-pulse" />KEY</span><span className="text-sm font-sans-tech font-medium text-gray-900">Wednesday, February 25, 2026</span></div>
                <div className="flex-1"><p className="text-sm text-gray-700 font-sans-tech">Ordinary Floor Session — <strong>historical calendar reference; voting outcome pending verification</strong></p></div>
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-xl p-5">
              <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
                <div className="flex items-center gap-2"><span className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-gray-200 text-gray-700 rounded-lg text-xs font-sans-tech font-semibold"><Clock size={12} />SESSION</span><span className="text-sm font-sans-tech font-medium text-gray-900">Thursday, February 26, 2026</span></div>
        ...
        <section className="mb-10">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div><h2 className="font-serif-display text-xl sm:text-2xl font-light text-gray-900">Archived notice — February webinar</h2><p className="text-xs text-gray-500 font-sans-tech">Exclusive for CANACINTRA (National Chamber of the Manufacturing Industry) members</p></div>
          </div>
          <div className="bg-blue-50 border border-blue-200 rounded-xl p-5">
            <div className="flex items-center gap-2 mb-2"><span className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-blue-100 text-blue-700 rounded-lg text-xs font-sans-tech font-semibold"><Calendar size={12} />Thursday, February 26, 2026, 10:00 a.m.</span></div>
            ...
            <p className="text-sm text-blue-800 font-sans-tech">Past date. The registration link has been removed; this notice does not establish that a law was approved.</p>
          </div>
        </section>
