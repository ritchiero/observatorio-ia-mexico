...
export default function ActividadPageEn() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-8 md:py-10">
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6 sm:mb-8 flex items-center gap-3">
          <span className="text-cyan-600">⚡</span>
          Recent Activity
        </h1>
        <ActividadFeedEn actividad={actividad} />
      </div>
    </div>
  );
}
