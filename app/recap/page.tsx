              ...
              <header className="border-b border-gray-200 bg-white sticky top-0 z-50">
                      <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
                                <Link href="/" className="flex items-center gap-2 text-gray-600 hover:text-gray-900 transition-colors">
                                            <ArrowLeft size={18} />
                                            <span className="font-sans-tech text-sm">Volver al inicio</span>span>
                                </Link>Link>
                ...
                {loading ? (
                    ...
                    <div className="text-center py-20 bg-gray-50 rounded-2xl border border-gray-200">
                                ...
                                <p className="text-gray-500 font-sans-tech text-sm max-w-md mx-auto">
                                              El primer recap mensual se generará automáticamente el día 1 del próximo mes.
                                              Los agentes de IA recopilan y analizan toda la actividad del observatorio.
                                </p>p>
                    </div>div>
                  ) : (
                    <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                      {/* Sidebar: Lista de recaps */}
                                <div className="lg:col-span-1">
                                              <h3 className="font-sans-tech text-xs font-semibold text-gray-400 uppercase tracking-wider mb-3">
                                                              Ediciones
                                              </h3>h3>
                      ...
                      {/* Main content: Recap seleccionado */}
                      {selectedRecap && (
                                                    ...
                                                    <div className="mb-8">
                                                            ...
                                                            <span className="text-xs text-gray-400 font-mono">
                                                              {new Date(selectedRecap.createdAt).toLocaleDateString('es-MX')}
                                                                      ...
                                                                      <p className="text-gray-600 font-sans-tech text-base">
                                                                        {selectedRecap.subtitulo}
                                                                      </p>p>
                                                    </div>div>
                                      ...
                                      {selectedRecap.statsSnapshot && (
                                                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-8">
                                                                            <div className="bg-gray-50 border border-gray-200 rounded-xl p-4 text-center">
                                                                                                  <div className="font-serif-display text-2xl text-gray-900">
                                                                                                    {selectedRecap.statsSnapshot.totalAnuncios}
                                                                                                    </div>div>
                                                                                                  <div className="text-[10px] font-sans-tech text-gray-500 uppercase tracking-wider">Anuncios</div>div>
                                                                            </div>div>
                                                                            <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-4 text-center">
                                                                                                  <div className="font-serif-display text-2xl text-emerald-600">
                                                                                                    {selectedRecap.statsSnapshot.operando}
                                                                                                    </div>div>
                                                                                                  <div className="text-[10px] font-sans-tech text-emerald-600 uppercase tracking-wider">Operando</div>div>
                                                                            </div>div>
                                                                            <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 text-center">
                                                                                                  <div className="font-serif-display text-2xl text-blue-600">
                                                                                                    {calcularCumplimiento(selectedRecap.statsSnapshot)}%
                                                                                                    </div>div>
                                                                                                  <div className="text-[10px] font-sans-tech text-blue-600 uppercase tracking-wider">Cumplimiento</div>div>
                                                                            </div>div>
                                                                            <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 text-center">
                                                                                                  <div className="font-serif-display text-2xl text-amber-600">
                                                                                                    {selectedRecap.statsSnapshot.totalIniciativas || '—'}
                                                                                                    </div>div>
                                      ...
                                      {selectedRecap.veredicto && (
                                                        <div className="bg-blue-50 border border-blue-200 rounded-2xl p-6 mb-8">
                                                                            <div className="flex items-start gap-3">
                                                                                                  ...
                                                                                                  <div>
                                                                                                                          <h3 className="font-sans-tech text-xs font-semibold text-blue-600 uppercase tracking-wider mb-2">
                                                                                                                                                    Veredicto del Mes
                                                                                                                            </h3>h3>
