      ...
      <section className="bg-gradient-to-b from-gray-50 to-white py-12 px-4 border-b border-gray-200">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg text-gray-600 mb-6">
            Iniciativas, reformas y dictámenes sobre regulación de IA en el Congreso
          </p>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-cyan-50 border border-cyan-200 rounded-lg p-8 text-center">
            ...
            <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
              ...
              dictámenes sobre IA en la Cámara de Diputados y el Senado.
            </p>
            ...
            <div className="bg-white border border-cyan-200 rounded-lg p-6 max-w-2xl mx-auto text-left">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex items-start gap-2">
                  ...
                  <span>Iniciativas de regulación de IA generativa</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-cyan-500 mt-0.5">•</span>
                  <span>Reformas a la Ley Federal de Derechos de Autor</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-cyan-500 mt-0.5">•</span>
                  <span>Propuestas de Ley de Protección contra Deepfakes</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-cyan-500 mt-0.5">•</span>
                  <span>Dictámenes de comisiones sobre IA y privacidad</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-cyan-500 mt-0.5">•</span>
                  <span>Iniciativas de ética y gobernanza de IA</span>
                </li>
              </ul>
            </div>
