          ...
          <div className="border border-gray-200 rounded-2xl overflow-hidden">
            <div className="bg-gray-50 px-5 md:px-7 py-4 border-b border-gray-200 flex flex-wrap items-center gap-2 justify-between">
              ...
              <div className="flex flex-wrap gap-1.5">
                <span className="font-sans-tech text-[11px] uppercase tracking-wider bg-emerald-50 text-emerald-700 border border-emerald-200 rounded-full px-2 py-0.5">Fuente oficial</span>
                <span className="font-sans-tech text-[11px] uppercase tracking-wider bg-blue-50 text-blue-700 border border-blue-200 rounded-full px-2 py-0.5">Contraste automatizado</span>
                <span className="font-sans-tech text-[11px] uppercase tracking-wider bg-amber-50 text-amber-700 border border-amber-200 rounded-full px-2 py-0.5">Auditoría humana pendiente</span>
              </div>
            </div>
