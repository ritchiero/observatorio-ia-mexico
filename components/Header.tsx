      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-14 sm:h-16">
          ...
          <nav className="hidden sm:flex items-center gap-1">
            ...
            <Link href={p('/mapa-vivo')} className="px-3 py-1.5 text-sm font-medium text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded-lg transition-all">{t.mapaVivo}</Link>
        ...
        {menuOpen && (
          <nav className="sm:hidden border-t border-gray-200 py-3 space-y-1">
            ...
            <Link href={p('/mapa-vivo')} onClick={() => setMenuOpen(false)} className="flex items-center gap-2 px-3 py-2.5 text-sm font-medium text-gray-600 hover:bg-gray-100 hover:text-gray-900 rounded-lg transition-colors">{t.mapaVivo}</Link>
