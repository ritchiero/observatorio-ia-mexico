...
export type ActividadTipo = 'nuevo_anuncio' | 'cambio_status' | 'actualizacion' | 'agente_ejecutado' | 'agente_parcial' | 'agente_fallo' | 'anuncio_manual' | 'nueva_iniciativa' | 'correccion';
